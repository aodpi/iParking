...
namespace iParking.Migrations
{
    ...
    [Migration("20180520164559_parking_relation")]
    partial class parking_relation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iParking.Models.Parking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("iParking.Models.ParkingReservation", b =>
                {
                    b.HasOne("iParking.Models.Parking", "Parking")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("iParking.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
